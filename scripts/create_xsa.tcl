...
if { [string first $scripts_vivado_version $current_vivado_version] == -1 } {
   puts "WARNING: This design was made using Vivado $scripts_vivado_version but you are using version $current_vivado_version."
}
...
file mkdir $build_dir/bd

create_project -part $part -force $design_name $build_dir/bd
...
validate_hw_platform build/$design_name.xsa
